    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Join Shared Goal</h1>
        </div>
        ...
        {status === "need-login" && (
          <div className="text-center py-4">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1 max-w-xs mx-auto">You need an account to join a shared goal. We&apos;ll bring you back here after.</p>
            <Link
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-3">
              ...
              <Link href={`/signup?redirect=/goals/join/${token}`} className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">Sign up</Link>
            </p>
          </div>
        )}
        ...
        {status === "not-found" && (
          <div className="text-center py-4">
            <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-red-950/40 flex items-center justify-center mx-auto mb-3">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">This link is invalid or has been revoked.</p>
            <Link href="/goals" className="mt-4 inline-block text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">Go to your goals →</Link>
          </div>
        )}
        ...
        {status === "expired" && (
          <div className="text-center py-4">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Ask the goal owner to send you a new link.</p>
            <Link href="/goals" className="mt-4 inline-block text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">Go to your goals →</Link>
          </div>
        )}
        ...
        {status === "already-member" && goal && (
          <div className="text-center py-4">
            <div className="w-12 h-12 rounded-full bg-green-50 dark:bg-green-950/40 flex items-center justify-center mx-auto mb-3">
              <CheckCircle size={22} className="text-green-600 dark:text-green-400" />
            </div>
            <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">You&apos;re already a member</p>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">You have access to &quot;{goal.name}&quot;.</p>
          ...
          <>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 flex items-center gap-3 mb-5">
              {goal.image_url ? (
                ...
                <img src={goal.image_url} alt="" className="w-14 h-14 rounded-xl object-cover border border-gray-100 dark:border-gray-800 shrink-0" />
              ) : (
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                  <span className="font-medium text-gray-700 dark:text-gray-300">${saved.toFixed(2)}</span>
            ...
            <Link href="/goals" className="block mt-2 text-center text-xs text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300">No thanks</Link>
          </>
        )}
        ...
        {status === "accepted" && goal && (
          <div className="text-center py-4">
            ...
            <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">🎉 You joined &quot;{goal.name}&quot;!</p>
